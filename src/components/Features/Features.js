...
const Features = () => {
  return (
    <div className="mt-4 mx-auto text-center">
      <p className="font-medium text-4xl font-serif mb-4">Our Features</p>
      <div className="flex flex-wrap justify-center gap-10">
        ...
        <div className="text-center w-[200px] h-[250px] rounded-lg border-2 p-4 shadow-xl">
          ...
          <div>
            ...
            <p className="text-sm mt-2">Your need is our chance of service. Give us a chance and you will be satisfied</p>
          </div>
        </div>
        {/* Box 2 */}
        <div className="text-center w-[200px] h-[250px] rounded-lg border-2 p-4 shadow-xl">
