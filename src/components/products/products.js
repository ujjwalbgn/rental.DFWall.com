...
const Products = () => {
  return (
    ...
    <div>
      <p className="font-medium text-4xl font-serif text-center mb-9">Our Products</p>
      <div className="gap-20 items-center justify-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-10">
        ...
        <div className="text-center w-[300px] h-[400px] rounded-lg border-2 p-4 shadow-xl">
            <div>
              ...
              <Image src={Product1id2} className='w-full h-[200px]' alt="Folding Chairs"/>
              <p className="text-lg mt-4">Comfortable and durable folding chairs for any event.</p>
        ...
        <div className="text-center w-[300px] h-[400px] rounded-lg border-2 p-4 shadow-xl">
            <div>
              ...
              <Image src={Product2id1} className='w-full h-[200px]' alt="Folding Tables"/>
              <p className="text-lg mt-4">Versatile folding tables perfect for gatherings and parties.</p>
          ...
          <div className="text-center w-[300px] h-[400px] rounded-lg border-2 p-4 shadow-xl">
            <div>
              ...
              <Image src={Product3id1} className='w-full h-[200px]' alt="Cornhole Boards"/>
              <p className="text-lg mt-4">High-quality cornhole boards for outdoor entertainment.</p>
          ...
          <div className="text-center w-[300px] h-[400px] rounded-lg border-2 p-4 shadow-xl">
            <div>
              ...
              <Image src={Product4id1} className='w-full h-[200px]' alt="Jumbo Jenga"/>
              <p className="text-lg mt-4">Giant Jenga set for a fun and challenging stacking game.</p>
              <p className="text-xl font-medium mt-2">$20 per day</p>
              <div className="flex items-center justify-center mt-2">
                <span className="text-yellow-500">&#9733; &#9733; &#9733; &#9733; &#9734;</span>
          ...
          <div className="text-center w-[300px] h-[400px] rounded-lg border-2 p-4 shadow-xl">
            <div>
              ...
              <Image src={Product5id1} className='w-full h-[200px]' alt="Giant Connect Four"/>
              <p className="text-lg mt-4">Enjoy the classic Connect Four game in a giant format.</p>
              <p className="text-xl font-medium mt-2">$20 per day</p>
              <div className="flex items-center justify-center mt-2">
                <span className="text-yellow-500">&#9733; &#9733; &#9733; &#9733; &#9733;</span>
